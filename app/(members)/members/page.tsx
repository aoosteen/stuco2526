...
const page = async () => {
  ...
  return (
    ...
    >
      {/* <div
        className=" h-[620vh] overflow-hidden  w-screen absolute top-0 left-0  bg-[url(../public/members/Doodle.png)] bg-contain 
      bg-repeat-round opacity-40"
      /> */}
      <div className="relative  shrink-0 h-[55vh] flex flex-col justify-center px-16">
        ...
        <Image
          priority
          src={"/members/MembersBanner.webp"}
          alt="red banner"
          width={1100}
          height={1100}
          className="w-screen object-cover scale-x-101 absolute top-0 left-0 h-full"
        />
      </div>
