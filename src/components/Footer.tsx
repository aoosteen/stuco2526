      ...
      <div className="relative z-10 flex flex-col md:flex-row justify-between items-start gap-16 md:gap-20">
        ...
        <div className="flex-1">
          ...
          <div className="flex flex-col gap-8">
            <a href="mailto:jny.sc@example.com" className="hover-trigger flex items-center gap-4 text-lg font-sans uppercase tracking-widest hover:text-[#8b0836] transition-colors group">
              <div className="w-10 h-10 rounded-full border border-black/10 flex items-center justify-center group-hover:border-[#8b0836] transition-colors shrink-0">
                <Mail size={18} />
              </div>
              jny.sc@example.com
            </a>
            ...
            <div className="flex flex-wrap gap-8">
              ...
              <a href="#" target="_blank" rel="noreferrer" className="hover-trigger flex items-center gap-4 text-lg font-sans uppercase tracking-widest hover:text-[#024a70] transition-colors group">
                <div className="w-10 h-10 rounded-full border border-black/10 flex items-center justify-center group-hover:border-[#024a70] transition-colors shrink-0">
                  <Youtube size={18} />
                </div>
                YouTube
              </a>
              <a href="#" target="_blank" rel="noreferrer" className="hover-trigger flex items-center gap-4 text-lg font-sans uppercase tracking-widest hover:text-[#8b0836] transition-colors group">
                <div className="w-10 h-10 rounded-full border border-black/10 flex items-center justify-center group-hover:border-[#8b0836] transition-colors shrink-0">
                  <Music size={18} />
                </div>
                TikTok
        ...
        <div className="flex-1 w-full max-w-md relative">
          <motion.div 
            initial={{ rotate: -2 }}
            whileHover={{ rotate: 0 }}
            className="bg-[#ffffff] text-black p-8 md:p-10 shadow-[20px_20px_0px_rgba(0,0,0,0.1)] relative"
          >
            ...
            <form className="flex flex-col gap-4" onSubmit={(e) => e.preventDefault()}>
              ...
              <button className="mt-4 bg-black text-white py-4 font-sans uppercase tracking-widest font-bold hover:bg-[#8b0836] transition-colors hover-trigger">
                Send Note
              </button>
            </form>
          </motion.div>
