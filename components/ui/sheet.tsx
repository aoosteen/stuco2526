    ...
    <SheetPortal>
      ...
      <SheetPrimitive.Content
        ...
        className={cn(
          ...
          side === "right" &&
            "data-[state=closed]:slide-out-to-right data-[state=open]:slide-in-from-right inset-y-0 right-0 h-full w-screen border-l sm:max-w-sm",
          side === "left" &&
      ...
      >
        {children}
        <SheetPrimitive.Close className="  absolute top-8 right-8  opacity-70 transition-opacity hover:opacity-100 disabled:pointer-events-none">
        <X size={24} className="stroke-1 cursor-pointer"/>
